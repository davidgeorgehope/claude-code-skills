...
| Color            | Proportion | Role                                              |
|------------------|------------|----------------------------------------------------|
| Developer Blue   | **15%**    | Card/container outlines, decorative geometric line art, dark accents |
...
2. **Developer Blue is for outlines and line art, not backgrounds.** At 15%, use it for card/container outlines, decorative geometric shapes, and occasional dark accents — NOT as a slide background, footer bar, or section divider background. Elastic Blue owns all hero/dark slide moments.
...
- Developer Blue appears only as card/container outlines and decorative geometric line art — never as a slide background or footer bar
...
- Hero sections: Elastic Blue with White text (primary). Developer Blue for card outlines and container borders, not as hero backgrounds
