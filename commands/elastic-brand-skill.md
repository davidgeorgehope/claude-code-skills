...
| Name            | Hex       | RGB                | Usage                          |
|-----------------|-----------|--------------------|--------------------------------|
| Developer Blue  | `#101C3F` | rgb(16, 28, 63)    | Dark contrast sections, dividers |
| Light Grey      | `#F5F7FA` | rgb(245, 247, 250) | Alternating section backgrounds  |
| White           | `#FFFFFF` | rgb(255, 255, 255) | Default/clean backgrounds        |
| Elastic Blue    | `#0B64DD` | rgb(11, 100, 221)  | Primary hero/feature backgrounds |
...
| Color            | Proportion | Role                                              |
|------------------|------------|----------------------------------------------------|
| Developer Blue   | **15%**    | Occasional dark contrast sections, section dividers, footers |
...
2. **Developer Blue is for contrast moments.** At 15%, use it for occasional section dividers, dark-mode panels, or a single dramatic slide — not as the default background for title or closing slides. Elastic Blue owns those.
...
- Title slides: Elastic Blue background with White text (primary brand statement)
- Content slides: White or Light Grey backgrounds with Dark Ink/Ink text (alternate between them for rhythm)
- Closing/CTA slides: Elastic Blue background with White text
- Section divider slides: Developer Blue background with White text (use sparingly — 1-2 per deck max)
...
- Developer Blue is a supporting dark moment, not the default dark background for every non-content slide
...
- Hero sections: Elastic Blue with White text (primary), Developer Blue for occasional dark contrast sections
